...
+(BOOL)initEventTap {
    ...
    // No need to call CFRunLoopRun() - the main run loop is already
    // running via NSApplicationMain(). Calling it here creates a nested
    // run loop that blocks NSMenu tracking on modern macOS.
